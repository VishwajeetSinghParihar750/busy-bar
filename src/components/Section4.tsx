export default function Section4() {
  return (
    <section className="bg-bg py-24  overflow-hidden panel ">
        ...
        <div className="container  z-0  ">
          ...
          <div className="w-2/5 flex z-0 flex-col gap-12  relative py-24  overflow-x-visible ">
            <div className="font-normal">
              ...
              <span className="text-brand border-b">desktop software</span> and
              automatically activates when you’re on a call, live on stream,
              ...
              <div className="flex items-center">
                ...
                <div className="flex flex-col max-w-[45ch]">
                  ...
                  <div className="text-base text-fg-muted mt-1">
                    When the microphone is activated on your computer, BUSY Bar
                    will automatically display an ON CALL status.
                  </div>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div className="flex flex-col max-w-[45ch]">
                  ...
                  <div className="text-base text-fg-muted mt-1">
                    ...
                    Broadcaster Software), BUSY Bar will automatically turn on.
                  </div>
                </div>
              </div>
              <div className="flex items-center">
      ...
      <div className="bg-bg-muted rounded-4xl container mt-20 font-normal overflow-hidden relative">
        <div className="p-16 pb-0 absolute  z-0">
          <div className="text-5xl">Remote control over Wi-Fi</div>
          <div className="mt-4 max-w-[50ch]">
            Control BUSY Bar remotely over the internet. Place it on the wall or
            door and use the desktop app to automatically activate the BUSY
