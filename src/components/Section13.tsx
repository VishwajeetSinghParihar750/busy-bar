    ...
    <section className="py-20 panel bg-bg">
      <div className="content container flex gap-20 flex-col">
        <div className="flex gap-20">
          ...
          <div className="flex-4 gap-4 flex flex-col self-center">
            <div className="text-4xl">
              <BlockReveal>What is Matter protocol?</BlockReveal>
            </div>
            <div className="font-normal">
              <BlockReveal>
                Matter is a modern smart home protocol developed by Apple,
                Google, Amazon, and Samsung to address the issue of smart device
                incompatibility and security. Designed for seamless
                interoperability, Matter ensures that supported devices can
                easily integrate into all major smart home platforms without the
                need for additional apps or software.
              </BlockReveal>
            </div>
            <div className="text-sm text-fg-muted font-normal">
              <BlockReveal>
                We are a member of the Connectivity Standards Alliance
                (CSA-IoT), and our products are currently in the process of
                being certified to work with the Matter standard.
              </BlockReveal>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-20">
          <div className="flex-4 gap-4 flex flex-col self-center">
            <div className="text-4xl">
              <BlockReveal>Home Assistant support</BlockReveal>
            </div>
            <div className="font-normal">
              <BlockReveal>
                ...
                Assistant, such as displaying a message when your washing
                machine has finished its cycle.
              </BlockReveal>
            </div>
            <div className="text-sm text-fg-muted font-normal">
              <BlockReveal>
                Home Assistant is the most popular open-source smart home hub,
                with a wide range of integrations, powerful automation, and
                local control.
              </BlockReveal>
            </div>
            <img
