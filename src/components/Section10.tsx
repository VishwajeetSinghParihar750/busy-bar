        ...
        <div className="container max-w-lg mx-0 py-[20dvh] pl-[5vw]">
          <div className="flex flex-col z-0 gap-8">
            <div className="text-6xl font-medium">
              <BlockReveal>Pause scrolling</BlockReveal>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex flex-col gap-2">
                <div>
                  <BlockReveal>Block any app</BlockReveal>
                </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="flex flex-col gap-2">
                <div>
                  <BlockReveal>Hardcore mode (optional)</BlockReveal>
                </div>
                <div className="text-sm text-fg-muted">
                  <BlockReveal>
                    Locks apps for the entire focus session with no way to
                    bypass it. The only way to unlock them is a full phone
                    reset.
                  </BlockReveal>
                </div>
              </div>
