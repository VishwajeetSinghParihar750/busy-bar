export default function Sectin10() {
  return (
    <section className="relative h-dvh overflow-hidden bg-[#f9f9f9] z-0">
      <video
      ...
      ></video>
      <div className="container max-w-lg mx-0 my-[25dvh] ml-[5vw]">
        <div className="flex flex-col z-0 gap-8">
          <div className="text-6xl font-medium">Pause scrolling</div>

          <div className="font-normal ">
            Short videos on TikTok and Instagram flood you with dopamine, making
            it hard to focus. BUSY App can blocks these apps while you’re in
            deep focus.
          </div>
          <div className="flex gap-4 items-start">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="text-sm text-fg-muted">
                Select the apps you want to block during focus mode. You’ll stop
                receiving notifications and won’t be able to open these apps
